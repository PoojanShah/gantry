...
public static class Mouse{
     ...
     public static Vector2 position{get{Update();return m_CurrentMousePos;}}
     public static Vector2 lastPosition{get{Update();return m_LastMousePos;}}
     public static Vector2 delta{get{Update();return m_CurrentDelta;}}
     public static Vector2 deltaReverseY{get{
            Update();
            Vector2 d=m_CurrentDelta;
            d.y*=-1;
            return d;
        } }
    ...
    static void Update(){
         ...
         for(int i=0;i<m_DragStartVector.Length;i++){
             if(Input.GetMouseButtonDown(i))m_DragStartVector[i]=m_CurrentMousePos;
             if(Input.GetMouseButton(i))m_DragVector[i]=m_CurrentMousePos-m_DragStartVector[i];
         }
    }
}